...
Private Sub cmdPREVIEW_Click()
 ...
 Dim dr_amt, cr_amt As Double
    ...
    ''==============NO Need after date 25.06.05 this opening balance =====for opening balance====================
...
Private Sub GetUserAcc()
    On Error GoTo err_loop
        ...
        Adodc1.RecordSource = "select user_acc,acc_name from acct where acc_lbl<>0 order by user_acc"
        Adodc1.Refresh
