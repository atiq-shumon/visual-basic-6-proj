...
Public Function ConvertX(nbrNumber As Double) As String
    ...
    If intDECI > 0 Then
     ...
     '   Dim strFlot1 As String
        ...
        If L = "0" And R <> "0" Then
           strFlot = "  AND CENTS ZERO " & Word1(R)
           GoTo stp
        End If
        
        If L <> "0" And R = "0" Then
           strFlot = " AND CENTS " & Word1(L) & " ZERO "
           GoTo stp
        End If
        ...
        If L <> "" And R <> "" Then
           strFlot = " AND CENTS " & Word1(L) & "  " & Word1(R)
           GoTo stp
        End If
...
stp:
    ...
    If strFlot = "" Then
       ConvertX = "SAY U.S. DOLLAR " & strHole & " ONLY"
    Else
       ConvertX = "SAY U.S. DOLLAR:  " & strHole & strFlot & " ONLY"
    End If
