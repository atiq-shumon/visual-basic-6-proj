...
Begin VB.Form frmsubjectinfo_sub 
   BackColor       =   &H8000000B&
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image1 
         Height          =   1020
         Left            =   -30
         Picture         =   "frmsubjectinfo_sub.frx":0000
         Stretch         =   -1  'True
         Top             =   -30
         Width           =   9705
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "frmsubjectinfo_sub.frx":CEA5
         Left            =   1650
         List            =   "frmsubjectinfo_sub.frx":CEA7
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmsubjectinfo_sub.frx":CEA9
         Left            =   1650
         List            =   "frmsubjectinfo_sub.frx":CEAB
         Style           =   2  'Dropdown List
         TabIndex        =   1
         ToolTipText     =   "Select Class"
         Top             =   690
   ...
   End
End
Attribute VB_Name = "frmsubjectinfo_sub"
...
Set rs1 = getdata("SELECT Sub_code From Subject_Info_sub_history where M_code='" & Trim(Combo1.Text) & "' and Sub_code='" & Trim(txtfields(0).Text) & "' and class_code='" & Trim(Combo2.Text) & "'")
If Not rs1.EOF Then
   MsgBox "Delete teacher assignment first..Please verify.", vbInformation, cmp
   Exit Sub
End If
...
Dim rs1 As New ADODB.Recordset
Set rs1 = getdata("SELECT class_code,M_code,Sub_code,Sub_title From Subject_Info_sub where Class_code='" & Trim(Combo2.Text) & "' and m_code='" & Trim(Combo1.Text) & "'")
If Not rs1.EOF Then
    i = 1
    With MSFlexGrid1
        Do Until rs1.EOF
