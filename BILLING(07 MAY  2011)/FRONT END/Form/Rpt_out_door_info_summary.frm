...
Begin VB.Form Rpt_out_door_info_summary 
   ...
   Begin VB.CommandButton cmdPreview 
      ...
      Height          =   420
      Left            =   60
      Picture         =   "Rpt_out_door_info_summary.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   3
      ToolTipText     =   "Preview"
      Top             =   2610
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   420
      Left            =   630
      Picture         =   "Rpt_out_door_info_summary.frx":066A
      Style           =   1  'Graphical
      TabIndex        =   2
      ToolTipText     =   "Exit"
      Top             =   2610
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboShift 
         ...
         DataSource      =   "Adodc1"
         Height          =   315
         ItemData        =   "Rpt_out_door_info_summary.frx":0F88
         Left            =   2580
         List            =   "Rpt_out_door_info_summary.frx":0F8A
         TabIndex        =   17
         Top             =   1590
         Width           =   1965
      End
      ...
      Begin VB.ComboBox rptOutCombo 
         ...
         DataSource      =   "Adodc1"
         Height          =   315
         ItemData        =   "Rpt_out_door_info_summary.frx":0F8C
         Left            =   360
         List            =   "Rpt_out_door_info_summary.frx":0F8E
         TabIndex        =   1
         Top             =   870
         Width           =   4185
      End
