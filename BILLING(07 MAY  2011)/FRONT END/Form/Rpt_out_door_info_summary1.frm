...
Begin VB.Form Rpt_out_door_info_summary 
   BackColor       =   &H00C9AD8F&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Pathological Test Summary"
   ClientHeight    =   3075
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   5085
   ...
   Begin VB.CommandButton cmdPreview 
      ...
      Height          =   420
      Left            =   30
      Picture         =   "Rpt_out_door_info_summary1.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   3
      ToolTipText     =   "Preview"
      Top             =   2610
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   420
      Left            =   540
      Picture         =   "Rpt_out_door_info_summary1.frx":066A
      Style           =   1  'Graphical
      TabIndex        =   2
      ToolTipText     =   "Exit"
      Top             =   2610
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboShift 
         ...
         DataSource      =   "Adodc1"
         Height          =   315
         ItemData        =   "Rpt_out_door_info_summary1.frx":0F88
         Left            =   2580
         List            =   "Rpt_out_door_info_summary1.frx":0F8A
         TabIndex        =   17
         Top             =   1590
         Width           =   1965
      End
      ...
      Begin VB.ComboBox rptOutCombo 
         ...
         DataSource      =   "Adodc1"
         Height          =   315
         ItemData        =   "Rpt_out_door_info_summary1.frx":0F8C
         Left            =   360
         List            =   "Rpt_out_door_info_summary1.frx":0F8E
         TabIndex        =   1
         Top             =   870
         Width           =   4185
      End
   ...
   End
End
Attribute VB_Name = "Rpt_out_door_info_summary"
