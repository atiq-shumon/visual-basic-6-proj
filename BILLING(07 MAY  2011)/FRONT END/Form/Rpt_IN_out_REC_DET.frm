...
Begin VB.Form Rpt__REC_DET 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Receipt No wise Report:in detail"
   ClientHeight    =   3315
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   4800
   ...
   Begin VB.CommandButton cmdPreview 
      ...
      Height          =   420
      Left            =   60
      Picture         =   "Rpt_IN_out_REC_DET.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   3
      ToolTipText     =   "Preview"
      Top             =   2820
   ...
   Begin VB.CommandButton cmdExit 
      ...
      Height          =   420
      Left            =   600
      Picture         =   "Rpt_IN_out_REC_DET.frx":066A
      Style           =   1  'Graphical
      TabIndex        =   2
      ToolTipText     =   "Exit"
      Top             =   2820
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboshift1 
         ...
         ForeColor       =   &H00C00000&
         Height          =   360
         ItemData        =   "Rpt_IN_out_REC_DET.frx":0F88
         Left            =   2610
         List            =   "Rpt_IN_out_REC_DET.frx":0F8A
      ...
      Begin VB.ComboBox cboShift 
         ...
         ForeColor       =   &H00C00000&
         Height          =   360
         ItemData        =   "Rpt_IN_out_REC_DET.frx":0F8C
         Left            =   2610
         List            =   "Rpt_IN_out_REC_DET.frx":0F8E
         Style           =   2  'Dropdown List
         TabIndex        =   17
         Top             =   1920
         Width           =   1965
      ...
      Begin VB.ComboBox rptOutCombo 
         ...
         DataSource      =   "Adodc1"
         Height          =   315
         ItemData        =   "Rpt_IN_out_REC_DET.frx":0F90
         Left            =   360
         List            =   "Rpt_IN_out_REC_DET.frx":0F92
         TabIndex        =   1
         Top             =   1200
         Width           =   4185
      End
   ...
   End
End
Attribute VB_Name = "Rpt__REC_DET"
